...
// the configuration data for the board. In addition, the HW pins for I2C, analog inputs
// and so on are set from the current RPico Defaults. Check the schematic for the board
// to see all pin assignments.
//
//----------------------------------------------------------------------------------------
