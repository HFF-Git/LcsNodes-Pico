...
// a DCC packet in human readable format. There are methods that analyze a DCC 
// packet for length, checksum and instruction type. The formatting routines will 
// build a string with a binary, hexadecimal or content formatted data.
//
///---------------------------------------------------------------------------------------
//
