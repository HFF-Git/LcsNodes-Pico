...
struct LcsDccTrack {
    ...
    volatile uint16_t   shorCircuitEventCount           = 0;
    volatile uint16_t   overloadEventCount              = 0;
    volatile uint16_t   overloadRestartCount            = 0;
    ...
    volatile uint16_t   shortCircuitEventThreshold      = 0;
    volatile uint16_t   overloadEventThreshold          = 0;
    volatile uint16_t   overloadRestartThreshold        = 0;
    ...
    volatile uint16_t   maxCurrentDigitValue            = 0;
