...
// board. We also call this library a "driver". The driver provides a set of 
// defined interfaces to the upper level extension library. Being a driver, it 
// truly knows the hardware underneath and maps the upper level calls to the lower
// level hardware calls to make.
//
///---------------------------------------------------------------------------------------
//
