...
namespace LCS {
    ...
    //------------------------------------------------------------------------------------
    // "crc32_update" is used to build a checksum over a series of blocks, 
    // since we can only handle one block transfer at a time.
    //
    //------------------------------------------------------------------------------------
...
namespace LCS {
    ...
    // now, all we need is to define LCS messages that send the data in 8-byte
    // messages,  accumulate the data in 1Kbyte data blocks, verify the block
    // checksum, update the CRC32 checksum and finally test the overall 
    // checksum.
